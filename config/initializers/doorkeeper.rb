Doorkeeper.configure do
  ...
  # Optional: Custom introspection response (for `/oauth/token/info`)
  custom_introspection_response do |token, _|
    {
      active: token&.accessible?,
...
#
# realm "Doorkeeper"
Doorkeeper::Rails::Helpers.module_eval do
  private
  ...
  def doorkeeper_unauthorized_render_options(error: nil)
    {
      json: {
        ...
        error_description: error.try(:description)
      }
    }
  end
end
