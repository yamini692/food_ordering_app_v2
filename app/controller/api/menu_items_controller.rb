module Api
  class MenuItemsController < Api::ApplicationController
    ...
    def create
      ...
      if @menu_item.save
        render 'api/menu_items/create', status: :created
      else
    ...
    def update
      if @menu_item.update(menu_item_params)
        render 'api/menu_items/show', status: :ok
      else
        render json: { errors: @menu_item.errors.full_messages }, status: :unprocessable_entity
      end
    end
    ...
    def top_rated
      ...
      render 'api/menu_items/top_rated'
    end
    ...
    def authorize_restaurant!
      forbidden unless @current_user&.role == "Restaurant"
    end
